<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="RealTblCustomers.aspx.vb" Inherits="Pages_RealTblCustomers"  Title="Real Tbl Customers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="NewRow">
    ...
    <aquarium:DataViewExtender id="view1Extender" runat="server" TargetControlID="view1" Controller="RealTblCustomers" view="grid1" ShowInSummary="True" SelectionMode="Multiple" SearchOnStart="True" />
  </div>
  <div data-flow="NewRow">
