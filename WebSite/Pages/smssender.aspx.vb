    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            If dt.Rows.Count > 0 Then
                'System.Threading.Thread.Sleep(dt.Rows.Count + 10)
                RadProgressBar1.MaxValue = dt.Rows.Count + 10
                RadProgressBar1.MinValue = 1
            End If
            For Each row As DataRow In dt.Rows
                ...
                If IsNothing(urlstringid) Or String.IsNullOrEmpty(urlstringid) Or String.IsNullOrWhiteSpace(urlstringid) Then
                    urlstringid = "1374"
                End If
                Dim smssendrequestuser As New smsbox.SoapUser()
                ...
                Dim smssendrequest As New smsbox.SendingSMSRequest With {
                    .User = smssendrequestuser,
                    .SenderText = urlstring.ToString(),
                    .RecipientNumbers = namestr,
                    .MessageBody = email
                }
                Dim smssendrequestresult As New smsbox.SendingSMSResult
                Dim smsboxservice As New smsbox.Messaging
                ...
                RadProgressBar1.Value = RadProgressBar1.Value + 1
