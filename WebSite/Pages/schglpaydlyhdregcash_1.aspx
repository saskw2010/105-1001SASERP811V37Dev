<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="schglpaydlyhdregcash_1.aspx.vb" Inherits="Pages_schglpaydlyhdregcash_1"  Title="Schglpaydlyhdregcash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  ...
  <div data-flow="NewRow">
    ...
    <aquarium:DataViewExtender id="view2Extender" runat="server" TargetControlID="view2" Controller="schglpaydlydetailpaymentcash" view="grid1" ShowInSummary="True" FilterSource="view1Extender" FilterFields="schglpaydlyhdregid" SelectionMode="Multiple" ShowActionButtons="Top" SearchOnStart="True" ShowPager="Top" ShowRowNumber="True" />
  </div>
</asp:Content>
