<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="BatchDaileypayment_2.aspx.vb" Inherits="Pages_BatchDaileypayment_2"  Title="Batch Daileypayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="NewRow">
    ...
    <aquarium:DataViewExtender id="view1Extender" runat="server" TargetControlID="view1" Controller="BatchDaileypayment" view="grid2" ShowInSummary="True" SelectionMode="Multiple" />
  </div>
