<%@ Page Language="VB" MasterPageFile="~/Main.Master" AutoEventWireup="false" CodeFile="schglvchdlyhdreg_1.aspx.vb" Inherits="Pages_schglvchdlyhdreg_1"  Title="Schglvchdlyhdreg" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="NewRow">
    ...
    <aquarium:DataViewExtender id="view1Extender" runat="server" TargetControlID="view1" Controller="schglvchdlyhdreg" view="grid1" ShowInSummary="True" PageSize="5" SelectionMode="Multiple" ShowActionButtons="Top" StartCommandName="New" StartCommandArgument="createForm1" SearchOnStart="True" ShowDetailsInListMode="False" />
  </div>
