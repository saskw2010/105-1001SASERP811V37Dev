    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim script As String =
                    "(function(){" & vbCrLf &
                    "  try {" & vbCrLf &
                    "    var asmx='" & asmxBase.Replace("'", "\'") & "';" & vbCrLf &
                    "    if (document && document.body) document.body.setAttribute('data-asmx-base', asmx);" & vbCrLf &
                    "    window.AppConfig = window.AppConfig || {};" & vbCrLf &
                    "    window.AppConfig.asmxBase = asmx;" & vbCrLf &
                    "    try { localStorage.setItem('saserp.asmxBase', asmx); } catch(e){}" & vbCrLf &
                    "  } catch(e) { console && console.warn && console.warn('asmxBase publish failed', e); }" & vbCrLf &
                    "})();"
