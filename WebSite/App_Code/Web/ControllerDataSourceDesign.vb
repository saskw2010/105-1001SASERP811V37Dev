    ...
    Public Class ControllerDataSourceDesignView
        ...
        Public Overrides ReadOnly Property Schema() As IDataSourceViewSchema
            Get
                ...
                Dim res As Stream = [GetType]().Assembly.GetManifestResourceStream(String.Format("eZee.Controllers.{0}.xml", DataController))
                If (res Is Nothing) Then
                    res = [GetType]().Assembly.GetManifestResourceStream(String.Format("eZee.{0}.xml", DataController))
                End If
