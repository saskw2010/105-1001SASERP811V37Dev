...
Namespace eZee.Rules
    ...
    Partial Public Class schApplication1BusinessRules
        Inherits eZee.Rules.SharedBusinessRules
        
        <RowBuilder("schApplication1", RowKind.New)>  _
        Public Sub BuildNewschApplication1()
        ...
        <ControllerAction("schApplication1", "Insert", ActionPhase.Before),  _
         ControllerAction("schApplication1", "Update", ActionPhase.Before)>  _
        Public Sub AssignFieldValuesToschApplication1( _
