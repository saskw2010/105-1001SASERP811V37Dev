...
Namespace eZee.Rules
    ...
    Partial Public Class contractshandler
        ...
        ''' <summary>
        ''' This method will execute in the view with id matching "editForm1" before an action
        ''' with a command name that matches "Update".
        ''' </summary>
        <Rule("Updateeditformr101")>  _
        Public Sub Updateeditformr101Implementation( _
