...
Namespace eZee.Rules
    ...
    Partial Public Class BatchDaileypaymentDetailesBusinessRules
        ...
        Public Sub r100Implementation( _
            ...
            Dim CacheFolder As String = System.IO.Path.Combine(appDirectory, "BatchDaileypaymentD")
            If Not System.IO.Directory.Exists(CacheFolder) Then
                System.IO.Directory.CreateDirectory(CacheFolder)
            End If
            Dim fileName As String = CacheFolder & "\" & BatchDaileypaymentD & ".bin"
            Dim output As Stream = File.Create(fileName)
            externalDoc.CopyTo(output)
            output.Close()
            'This is the placeholder for method implementation.BatchDaileypaymentD
        End Sub
    End Class
End Namespace
