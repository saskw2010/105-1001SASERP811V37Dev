...
Namespace eZee.Rules
    ...
    Partial Public Class contractshandler
        ...
        ''' with a command name that matches "Calculate" and argument that matches "Discountpercentage".
        ''' </summary>
        <Rule("Discountpercentager101")>  _
        Public Sub Discountpercentager101Implementation( _
