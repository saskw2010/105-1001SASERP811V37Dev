...
Namespace eZee.Rules
    ...
    Partial Public Class CardstudentBusinessRules
        ...
        ''' </summary>
        <Rule("r105")>  _
        Public Sub r105Implementation( _
                    ...
                    ByVal rosom_1 As Nullable(Of Decimal),  _
                    ByVal rosom_2 As Nullable(Of Decimal),  _
                    ByVal rosom_3 As Nullable(Of Decimal),  _
                    ByVal rosom_4 As Nullable(Of Decimal),  _
                    ByVal rosom_5 As Nullable(Of Decimal),  _
                    ByVal rosom_6 As Nullable(Of Decimal),  _
                    ByVal rosom_7 As Nullable(Of Decimal),  _
                    ByVal checkAccount_1 As String,  _
                    ByVal checkdate_1 As Nullable(Of DateTime),  _
                    ByVal moneypaidto_1 As Nullable(Of Decimal),  _
                    ByVal schBnk_No_1 As Nullable(Of Long))
