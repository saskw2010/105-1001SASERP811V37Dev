...
Namespace eZee.Rules
    ...
    Partial Public Class schglpaydlyhdreg3BusinessRules
        ...
        ''' </summary>
        <Rule("deletedschglpaydlyhdreg")>  _
        Public Sub deletedschglpaydlyhdregImplementation( _
                    ...
                    ByVal max_checkAccount As Nullable(Of Long),  _
