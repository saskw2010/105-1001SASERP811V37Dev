...
Namespace eZee.Rules
    ...
    Partial Public Class StsaldtlBusinessRules
        ...
        Public Sub r104Implementation( _
                    ...
                    ByVal doc_Brn_Brn_Nm As String,  _
                    ByVal doc_Brn_Cmp_Grp_Nm As String,  _
                    ...
                    ByVal doc_Cstm_Cstm_Nm As String,  _
                    ByVal doc_Cstm_AreaArea_name As String,  _
                    ByVal doc_Cstm_EvaluationEvaluation_name As String,  _
                    ...
                    ByVal doc_Cstm_TSNEFTSNEF_name As String,  _
                    ByVal doc_Cstm_TSNEFNO1TSNEF1_name As String,  _
                    ByVal doc_Cstm_Slm_Slm_Nm As String,  _
                    ...
                    ByVal discount As Nullable(Of Long),  _
                    ...
                    ByVal darb As Nullable(Of Long),  _
                    ByVal paplcprc As Nullable(Of Long),  _
                    ByVal nakdy As Nullable(Of Long),  _
                    ByVal shad As Nullable(Of Double),  _
