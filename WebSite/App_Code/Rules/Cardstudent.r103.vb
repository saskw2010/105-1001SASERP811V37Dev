...
Namespace eZee.Rules
    ...
    Partial Public Class CardstudentBusinessRules
        ...
        ''' <summary>
        ''' Rule "moneypaidto_Converter" implementation:
        ...
        Public Sub r103Implementation( _
            ...
            'If (moneypaidto.HasValue AndAlso (Not ((Me.Arguments.CommandName = "Calculate")) OrElse (Me.Arguments.Trigger = "moneypaidto"))) Then
                'implement a conversion of the field value here
