...
Namespace eZee.Rules
    ...
    Partial Public Class contractshandler
        ...
        ''' with a command name that matches "Calculate" and argument that matches "Descountamountcalcx".
        ''' </summary>
        <Rule("Descountamountcalcxr100")>  _
        Public Sub Descountamountcalcxr100Implementation( _
                    ...
                    ByVal kmReading As Nullable(Of Long),  _
                    ByVal nOfDays As Nullable(Of Short),  _
                    ...
                    ByVal rtkmReading As Nullable(Of Long),  _
                    ...
                    ByVal usingcodsgmsgm_Nm As String,  _
                    ByVal usingcodsgmOpcoOpcoName As String,  _
                    ...
                    ByVal usingcod1sgmsgm_Nm As String,  _
                    ByVal usingcod1sgmOpcoOpcoName As String,  _
                    ...
                    ByVal latedayes As Nullable(Of Double),  _
