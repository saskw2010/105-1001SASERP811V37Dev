...
Namespace eZee.Rules
    ...
    Partial Public Class contractshandler
        ...
        ''' with a command name that matches "Calculate" and argument that matches "NOfDays".
        ''' </summary>
        <Rule("ajrcontractsNOfDaysr101")>  _
        Public Sub ajrcontractsNOfDaysr101Implementation( _
