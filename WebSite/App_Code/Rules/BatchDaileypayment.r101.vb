...
Namespace eZee.Rules
    ...
    Partial Public Class BatchDaileypaymentBusinessRules
        ...
        Public Sub r101Implementation( _
            ...
            sosostr = ActionArgs.Current.Item("batchDaileypayment").NewValue
           ' sosoname = ActionArgs.Current.Item("sgm").NewValue
            ...
            Result.NavigateUrl = "webreportviwer.aspx?reportquery=BatchDaileypayment&idfilter=" & sosostr    '& "&sosoname=" & sosoname
            Result.Continue()
        End Sub
    End Class
End Namespace
