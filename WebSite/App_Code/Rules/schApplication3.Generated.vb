...
Namespace eZee.Rules
    ...
    Partial Public Class schApplication3BusinessRules
        Inherits eZee.Rules.SharedBusinessRules
        
        <RowBuilder("schApplication3", RowKind.New)>  _
        Public Sub BuildNewschApplication3()
        ...
        <ControllerAction("schApplication3", "Insert", ActionPhase.Before),  _
         ControllerAction("schApplication3", "Update", ActionPhase.Before)>  _
        Public Sub AssignFieldValuesToschApplication3( _
