...
listName = listName.Replace("'", "-")
    ...
    Public Shared Function GetResourcemosso(ByVal keyVal As String) As String
        ...
        Else
            ...
            Dim filpathephsical As String = ""
            urlfilanl = Path.GetFileName(urlfilanl)
            urlfilanl = Left(urlfilanl, Len(urlfilanl) - 5)


            If IsNothing(ConfigurationManager.AppSettings("imagepathphysical")) = False Then

                filpathephsical = ConfigurationManager.AppSettings("imagepathphsical").ToString() + "\images\dashboard\" + urlfilanl + ".png"
                If (File.Exists(filpathephsical)) Then
                    Return filpathephsical
                Else
                    Return myvirtualpathfun() + "images/dashboard/10001.png"
                End If
            ...
            End If
            If IsNothing(ConfigurationManager.AppSettings("imagepathphysical")) = True And IsNothing(ConfigurationManager.AppSettings("imagepathphysical")) = True Then
                ...
                If (System.IO.File.Exists(filpathe + "\" + urlfilanl + ".png")) Then
                    ...
                    urlfilanl = filpathe + "\" + urlfilanl + ".png"
                    Return urlfilanl
                Else
                    Return myvirtualpathfun() + "images/dashboard/10001.png"
                End If
