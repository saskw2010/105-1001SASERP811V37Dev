...
Namespace eZee.Rules
    ...
    Partial Public Class GljrnvchhdrT1BusinessRules
        ...
        ''' </summary>
        <Rule("GLjrnvchT1100")>  _
        Public Sub GLjrnvchT1100Implementation( _
            ...
            'Result.NavigateUrl = "webreportviwer.aspx?reportquery=GLjrnvchT1&idfilter=" & sosostr & "&sosoname=" & sosoname
            'Result.continue
        End Sub
    End Class
End Namespace
