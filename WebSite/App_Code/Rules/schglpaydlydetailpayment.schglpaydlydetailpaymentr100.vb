...
Namespace eZee.Rules
    ...
    Partial Public Class schglpaydlydetailpaymentBusinessRules
        ...
        Public Sub schglpaydlydetailpaymentr100Implementation( _
                    ...
                    ByVal schglpaydlyhdregpayReferanceNo As String, _
                    ...
                    ByVal glcostcntr1cost_typCostcntr_Nm As String)
            'This is the placeholder for method implementation.
            ''schcheckaccountno

            'If ActionArgs.Current.Item("approved").Value = False Then '' check printed and approved or not
            If IsNothing(subaccountno) = False And IsNothing(cstyp_no) = False Then
                UpdateFieldValue("checkAccount", 0)

                Using calc As SqlText = New SqlText(
                        "select max(checkAccount) " +
                        "from [schcheckaccountno] where subaccountno=@subaccountno")
                    ...
                    Else
                        ...
                        UpdateFieldValue("checkAccount", Convert.ToDecimal(total) + 1)
                    End If
                End Using
            End If
            ' End If
