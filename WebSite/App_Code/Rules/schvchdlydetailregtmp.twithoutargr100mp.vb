...
Namespace eZee.Rules
    ...
    Partial Public Class schvchdlydetailregtmpBusinessRules
        ...
        ''' </summary>
        <Rule("twithoutargr100mp")>  _
        Public Sub twithoutargr100mpImplementation( _
            ...
            If ActionArgs.Current.CommandArgument = "Mony_Paid" Then
                ...
                If tekost = 0 Then
                    ...
                    sqlstatment = "INSERT INTO [schvchdlydetailregtmp] ([schvchdlyhdregid]  ,[branch] ,[StudentCode]  ,[acdcode] ,[FatherCode],[Trsd_Dt],[schpaymenttypeid]" & _
                   ...
                   " ,[trdb1] ,[Balance] FROM [GLschassmentBalance1001] where [Balance]>0 and [StudentCode]=" & ActionArgs.Current.Item("studentCode").NewValue & " and [acdcode]=" & ActionArgs.Current.Item("acdcode").NewValue
                    xinsert = dbinerto.Insert(sqlstatment)
                    Result.ShowAlert("click on refresh button")
