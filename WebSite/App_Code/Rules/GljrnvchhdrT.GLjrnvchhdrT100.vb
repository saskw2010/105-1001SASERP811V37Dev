...
Namespace eZee.Rules
    ...
    Partial Public Class GljrnvchhdrTBusinessRules
        ...
        ''' </summary>
        <Rule("GLjrnvchhdrT100")>  _
        Public Sub GLjrnvchhdrT100Implementation( _
            ...
            'Result.NavigateUrl = "webreportviwer.aspx?reportquery=GLjrnvchhdrT&idfilter=" & sosostr '& "&sosoname=" & sosoname
            'Result.continue
        End Sub
    End Class
End Namespace
