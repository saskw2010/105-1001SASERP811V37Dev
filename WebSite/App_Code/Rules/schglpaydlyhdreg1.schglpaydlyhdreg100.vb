...
Namespace eZee.Rules
    ...
    Partial Public Class schglpaydlyhdreg1BusinessRules
        ...
        ''' </summary>
        <Rule("schglpaydlyhdreg100")>  _
        Public Sub schglpaydlyhdreg100Implementation( _
            ...
            'sosostr = ActionArgs.Current.Item("schglpaydlyhdregid").NewValue

            'If ActionArgs.Current.Item("Pymnt_No").NewValue = 1 Then

            '    sosoname = ActionArgs.Current.Item("sgm").NewValue + ActionArgs.Current.Item("Pymnt_No").NewValue
            'Else
            ...
            'Result.NavigateUrl = "webreportviwer.aspx?reportquery=schglpaydlyhdreg&idfilter=" & sosostr & "&sosoname=" & sosoname
            'Result.Continue()
        End Sub
    End Class
End Namespace
