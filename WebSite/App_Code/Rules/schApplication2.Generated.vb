...
Namespace eZee.Rules
    ...
    Partial Public Class schApplication2BusinessRules
        Inherits eZee.Rules.SharedBusinessRules
        
        <RowBuilder("schApplication2", RowKind.New)>  _
        Public Sub BuildNewschApplication2()
        ...
        <ControllerAction("schApplication2", "Insert", ActionPhase.Before),  _
         ControllerAction("schApplication2", "Update", ActionPhase.Before)>  _
        Public Sub AssignFieldValuesToschApplication2( _
