...
Namespace eZee.Rules
    ...
    Partial Public Class SchStudentmos1001BusinessRules
        ...
        ''' with a command name that matches "Custom" and argument that matches "printstatment".
        ''' </summary>
        <Rule("SchStudentmos1001str100")>  _
        Public Sub SchStudentmos1001str100Implementation( _
