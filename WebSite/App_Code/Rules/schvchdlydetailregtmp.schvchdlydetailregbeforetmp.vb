...
Namespace eZee.Rules
    ...
    Partial Public Class schvchdlydetailregtmpBusinessRules
        ...
        ''' <summary>
        ''' This method will execute in the view with id matching "createForm1|editForm1" before an action
        ''' with a command name that matches "Insert|Update".
        ''' </summary>
        <Rule("schvchdlydetailregbeforetmp")>  _
        Public Sub schvchdlydetailregbeforetmpImplementation( _
			...
			UpdateFieldValue("totalbalance",0)
           end if
