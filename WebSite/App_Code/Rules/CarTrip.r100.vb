...
Namespace eZee.Rules
    ...
    Partial Public Class CarTripBusinessRules
        Inherits eZee.Rules.SharedBusinessRules
        
        ''' <summary>
        ''' Rule "CarTripinsertupdate" implementation:
        ''' This method will execute in the view with id matching "createForm1" after an action
        ''' with a command name that matches "Insert|Update".
        ''' </summary>
        <Rule("r100")>  _
        Public Sub r100Implementation( _
                    ByVal carTripID As Nullable(Of Long),  _
                    ...
                    ByVal tripKindid As Nullable(Of Long),  _
                    ByVal tripKindTripKindDesc As String,  _
                    ByVal tripflag As Nullable(Of Boolean),  _
