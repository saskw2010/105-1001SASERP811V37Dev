...
Namespace eZee.Data
    ...
    Public Class ControllerNodeSet
        ...
        Public Function SelectViews(ByVal ParamArray types() as System.[String]) As ControllerNodeSet
        ...
        Public Function SetShowInSelector(ByVal showInSelector As Boolean) As ControllerNodeSet
        ...
        Public Function SetHidden(ByVal hidden As Boolean) As ControllerNodeSet
            Return SetProperty("hidden", hidden.ToString().ToLower())
        End Function
        
        Public Function SetReadOnly(ByVal [readOnly] As Boolean) As ControllerNodeSet
            Return SetProperty("readOnly", [readOnly].ToString().ToLower())
        End Function
        
        Public Function SetFormatOnClient(ByVal formatOnClient As Boolean) As ControllerNodeSet
        ...
        Public Function SetFlat(ByVal flat As Boolean) As ControllerNodeSet
            Return SetProperty("flat", flat.ToString().ToLower())
        End Function
        
        Public Function SetNewColumn(ByVal newColumn As Boolean) As ControllerNodeSet
            Return SetProperty("newColumn", newColumn.ToString().ToLower())
        End Function
        
        Public Function SetFloating(ByVal floating As Boolean) As ControllerNodeSet
        ...
        Public Function SetColumns(ByVal columns As Integer) As ControllerNodeSet
            Return SetProperty("columns", columns)
        End Function
        
        Public Function SetRows(ByVal rows As Integer) As ControllerNodeSet
        ...
        ''' <returns>The node set containing the action.</returns>
        Public Function WhenKeySelected(ByVal keySelected As Boolean) As ControllerNodeSet
