...
Partial Public Class Dynwexreportxx
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Else
            ...
            If (designflag Is Nothing) Or (designflag = "false") Then
                ...
                StiWebViewerFx1.PdfUseUnicode = True
                StiWebViewerFx1.PdfStandardFonts = True
                StiWebViewerFx1.Report = report
                'StiWebViewerFx2.Report = report
                StiWebViewerFx1.Page.Title = translatemeyamosso.GetResourceValuemosso(reportFileName1)
                'Dim username As String
                'Dim timestampstring As String
                ...
                'Dim reportFileNamexz As String = appDirectory1 + "Pages\reportstock\web\" + reportFileName1 + username + timestampstring + ".pdf"
                ...
                'Response.Redirect("/pages/reportstock/web/pdfviewernewj.aspx?file=" + filenamefinal + ".pdf")
            ...
            If HttpContext.Current.User.IsInRole("ReportAsExcel") Then
                StiWebViewerFx1.ShowExportToExcel = True
            Else
                StiWebViewerFx1.ShowExportToExcel = False
            End If

            'If IsNothing(ConfigurationManager.AppSettings("exportexcel")) Then
            '    urlstring = "120"
            'Else
            '    urlstring = ConfigurationManager.AppSettings("exportexcel").ToString()
            '    If IsNothing(urlstring) Or String.IsNullOrEmpty(urlstring) Or String.IsNullOrWhiteSpace(urlstring) Then
            '        urlstring = "120"
            '    End If
            '    If urlstring = "100" Then
            '        StiWebViewerFx1.ShowExportToExcel = True
