...
Partial Public Class Controls_wexreportpdf
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Else
            ...
            If (System.IO.File.Exists(appDirectory + "\Reports\" + reportFileName1 + ".mrt")) Then
                ...
                Dim filenamefinal As String = reportFileName1 + username + timestampstring
                If Right(appDirectory1, 1) = "\" Then
                Else
                    appDirectory1 = appDirectory1 + "\"
                End If
                Dim urlstring As String
                If IsNothing(ConfigurationManager.AppSettings("pdfext")) Then
                    urlstring = "pdfviewernewj.aspx?file="
                Else
                    urlstring = ConfigurationManager.AppSettings("pdfext").ToString()
                End If
                Dim reportFileNamexz As String
                reportFileNamexz = appDirectory1 + "Pages\reportstock\web\" + reportFileName1 + username + timestampstring + ".pdf"

                If urlstring = "2" Then
                    reportFileNamexz = appDirectory1 + "Pages\WCPWebFormsVB\files\" + reportFileName1 + username + timestampstring + ".pdf"
                ...
                Dim PdfExport As StiPdfExportService = New StiPdfExportService()
                    ...
                    If urlstring = "pdfviewernewj.aspx?file=" Then
                        Response.Redirect("/pages/reportstock/web/" + urlstring + filenamefinal + ".pdf")
                    Else
                    If urlstring = "1" Then
                        Response.Redirect("~/Default4.aspx?reportquery=" + filenamefinal + ".pdf")
                    Else
                        If urlstring = "2" Then
                            Response.Redirect("~/Pages/WCPWebFormsVB/DemoPrintFilePDF.aspx?reportquery=" + filenamefinal + ".pdf")
                        Else
                            Response.Redirect("/pages/reportstock/web/" + filenamefinal + ".pdf")
                        End If
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        'pd.ShowDialog()
        PrinterSettings.PrinterName = "MyPrinterName"
        StiWebViewer1.Report.Print(False, PrinterSettings)
        'StiWebViewer1.Report.Web.StiReportResponse.ResponseAsPdf(me.page, report) 
    ...
    Protected Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Stimulsoft.Report.Web.StiReportResponse.ResponseAsPdf(Me.Page, StiWebViewer1.Report)
