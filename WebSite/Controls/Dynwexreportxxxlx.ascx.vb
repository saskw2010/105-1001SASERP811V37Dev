...
Partial Public Class Dynwexreportxxxlx
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Else
            ...
            If (designflag Is Nothing) Or (designflag = "false") Then
                ...
                Dim filenamefinal As String = reportFileName1 + username + timestampstring + ".xlsx"
                Dim reportFileNamexz As String = appDirectory1 + "Pages\reportstock\web\" + filenamefinal
                Dim xlxExport As StiExcel2007ExportService = New StiExcel2007ExportService()
                'PdfExport.PdfUseUnicode = True
                ''report.PdfStandardFonts = True
                ''report.PdfUseUnicode = True
                ''report.PdfStandardFonts = True
                xlxExport.ExportExcel(report, reportFileNamexz)

                Response.Redirect("/pages/reportstock/web/" + filenamefinal)
