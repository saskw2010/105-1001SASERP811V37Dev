<%@ Control Language="VB" AutoEventWireup="false" CodeFile="newcontent.ascx.vb" Inherits="Controls_newcontent"  %><div data-app-role="page" data-activator="Button|Carousel" data-content-framework="bootstrap">
    <div data-role="content">
                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p>
                                <a class="btn btn-lg btn-primary" href="#" role="button">Sign up today &raquo;</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p>
                                <a class="btn btn-lg btn-primary" href="#" role="button">Browse gallery &raquo;</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container marketing">
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    <img class="featurette-image img-responsive" src="../placeholder/eeeeee-aaaaaa-500.png"
