...
Partial Public Class Controls_wexreporresponse
        ...
        Else
            ...
            If (System.IO.File.Exists(appDirectory + "\Reports\" + reportFileName1 + ".mrt")) Then
                ...
                For i = 0 To report.CompiledReport.Dictionary.Databases.Count - 1
                    sqlDB1 = report.CompiledReport.Dictionary.Databases(i)
                ...
                Stimulsoft.Report.Web.StiReportResponse.ResponseAsPdf(Me.Page, report, True)
